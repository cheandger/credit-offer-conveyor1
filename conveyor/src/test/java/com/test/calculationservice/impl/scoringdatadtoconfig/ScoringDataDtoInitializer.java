...
public class ScoringDataDtoInitializer {
    ...
    public static ScoringDataDTO initialScoringDataDTO(BigDecimal amount, Integer term,
                                                       ScoringDataDTO.GenderEnum gender, LocalDate birthdate,
                                                       ScoringDataDTO.MaritalStatusEnum maritalStatus,
    ...
    public static EmploymentDTO initialEmploymentDTO(EmploymentDTO.EmploymentStatusEnum employmentStatus,
                                                     BigDecimal salary, EmploymentDTO.PositionEnum position,
